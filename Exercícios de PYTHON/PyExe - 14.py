...
peso = float(input('Ola, João Papo-de-Pescador, Informe o peso de peixes dessa viagem: '))
if peso > 50:
    excedeu = peso - 50
    multa = excedeu * 4
    multa_ar = round(multa, 2)
    print('Você excedeu o peso em: ',excedeu,'Kg. a multa sera de: R$', multa_ar)
else:
    print('Você não excedeu o limite! Pode ficar tranquilo!')
